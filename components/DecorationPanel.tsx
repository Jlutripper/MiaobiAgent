            ...
            <details className="bg-gray-900/50 p-3 rounded-lg border border-gray-700" open>
                ...
                <div className="mt-4 space-y-4">
                    ...
                    <div>
                        ...
                        <input type="number" value={decoration.zIndex} onChange={e => onUpdate({ zIndex: parseInt(e.target.value, 10) })} className="w-full p-2 bg-gray-700 border border-gray-600 rounded-md text-white" />
                ...
                <div className="mt-4 space-y-4">
                                 ...
                                 <div>
                                    <label className="text-sm">偏移 (px)</label>
                                     <div className="grid grid-cols-2 gap-2 mt-1">
                                         <input type="number" value={decoration.anchor.offset.x} onChange={e => onUpdate({ anchor: {...decoration.anchor!, offset: { ...decoration.anchor!.offset, x: parseInt(e.target.value, 10) || 0 }} })} placeholder="X" className="w-full p-1 bg-gray-700 border-gray-600 rounded"/>
                                         <input type="number" value={decoration.anchor.offset.y} onChange={e => onUpdate({ anchor: {...decoration.anchor!, offset: { ...decoration.anchor!.offset, y: parseInt(e.target.value, 10) || 0 }} })} placeholder="Y" className="w-full p-1 bg-gray-700 border-gray-600 rounded"/>
                                     </div>
                                </div>
                            </div>
                         )}
                     ...
                     {!decoration.anchor && (
                        <div>
                            ...
                            <div className="grid grid-cols-2 gap-2">
                                <input type="number" step="0.1" value={decoration.position.xPercent} onChange={e => onUpdate({ position: { ...decoration.position, xPercent: parseFloat(e.target.value) || 0 } })} className="w-full p-2 bg-gray-700 border border-gray-600 rounded-md text-white" />
                                <input type="number" value={decoration.position.yPx} onChange={e => onUpdate({ position: { ...decoration.position, yPx: parseInt(e.target.value) || 0 } })} className="w-full p-2 bg-gray-700 border border-gray-600 rounded-md text-white" />
                            </div>
                        </div>
                     )}
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number" value={decoration.sizePercent.width} onChange={e => onUpdate({ sizePercent: { width: parseFloat(e.target.value) || 0 } })} className="w-full p-2 bg-gray-700 border border-gray-600 rounded-md text-white" />
                        </div>
                         <div>
                            <label className="block text-sm font-medium text-gray-400 mb-1">旋转 (°)</label>
                            <input type="number" value={decoration.angle} onChange={e => onUpdate({ angle: parseInt(e.target.value, 10) || 0 })} className="w-full p-2 bg-gray-700 border border-gray-600 rounded-md text-white" />
                        </div>
                    </div>
                </div>
            </details>
                ...
                <div className="mt-4 space-y-4">
                     <div>
                        ...
                        <input
                            type="number"
                            min="0"
                            value={decoration.borderRadius || 0}
                    ...
                    <div>
                        ...
                        {decoration.shadow && (
                            <div className="space-y-2 pl-6">
                                ...
                                <div className="grid grid-cols-3 gap-2">
                                    <input type="number" value={decoration.shadow.offsetX} onChange={e => onUpdate({ shadow: { ...decoration.shadow!, offsetX: parseInt(e.target.value, 10) || 0 } })} className="w-full p-1 bg-gray-700 rounded-md" />
                                    <input type="number" value={decoration.shadow.offsetY} onChange={e => onUpdate({ shadow: { ...decoration.shadow!, offsetY: parseInt(e.target.value, 10) || 0 } })} className="w-full p-1 bg-gray-700 rounded-md" />
                                    <input type="number" value={decoration.shadow.blur} onChange={e => onUpdate({ shadow: { ...decoration.shadow!, blur: parseInt(e.target.value, 10) || 0 } })} className="w-full p-1 bg-gray-700 rounded-md" />
                                </div>
                     ...
                     <div>
                        ...
                        {decoration.stroke && decoration.stroke.width > 0 && (
                             <div className="space-y-2 pl-6">
                                <div className="grid grid-cols-2 gap-2">
                                    <input type="number" min="0" value={decoration.stroke.width} onChange={e => onUpdate({ stroke: { ...decoration.stroke!, width: parseInt(e.target.value, 10) || 0 } })} placeholder="宽度" className="w-full p-2 bg-gray-700 border border-gray-600 rounded-md" />
