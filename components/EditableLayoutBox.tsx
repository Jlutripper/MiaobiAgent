...
export const EditableLayoutBox = (props: EditableLayoutBoxProps) => {
    ...
    const handleMouseDown = (e: React.MouseEvent, type: 'drag' | 'resize-br') => {
        if ((!box.anchor && isGridChild) || !parentSize.width || box.isLocked) return;
    ...
    const handleMouseMove = useCallback((e: MouseEvent) => {
        if (!interactionRef.current || !parentSize.width || (!box.anchor && isGridChild)) return;
    ...
    }, [zoom, parentSize, path, onUpdate, isGridChild, box, otherBoxes, otherDecorations, onSetGuides]);
    ...
    return (
        ...
        >
            ...
            {isSelected(box.id) && !isGridChild && !box.anchor && !box.isLocked && (
                <>
                    <div
