...
import { createChat, getChatResponse } from './services/chatRouterService';
...
function App() {
    ...
    const startNewChat = () => {
        setIsThinking(true);
        const newChat = createChat(customTools, longArticleTemplates, posterTemplates);
    ...
    useEffect(() => {
        startNewChat();
    }, [customTools, longArticleTemplates, posterTemplates]);
    ...
    const processMessage = async (message: string) => {
        ...
        try {
            const route = await getChatResponse(chatSession, message);
        ...
        <div className="h-screen w-full bg-transparent font-sans flex flex-col">
            ...
            <div className="flex-grow min-h-0">
                <Chat 
                    ...
                    isTextInputDisabled={isThinking || !chatSession}
